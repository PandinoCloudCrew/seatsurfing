...
* **deps:** bump react-router-dom from 7.7.1 to 7.8.0 in /admin-ui ([#1160](https://github.com/PandinoCloudCrew/seatsurfing/issues/1160)) ([c41155a](https://github.com/PandinoCloudCrew/seatsurfing/commit/c41155aa9e8dbe4f20644e662248101d139d11ee))
...
* **deps:** bump react-router-dom from 7.8.1 to 7.8.2 in /admin-ui ([#1206](https://github.com/PandinoCloudCrew/seatsurfing/issues/1206)) ([c83e9bb](https://github.com/PandinoCloudCrew/seatsurfing/commit/c83e9bbe7a60043eb0b100fa1b8ce3b4a7ee39e4))
* **deps:** bump react-tooltip from 5.28.0 to 5.28.1 in /booking-ui ([#767](https://github.com/PandinoCloudCrew/seatsurfing/issues/767)) ([d40fae8](https://github.com/PandinoCloudCrew/seatsurfing/commit/d40fae88b69b496201869c46d1baf7435c4eb26e))
* **deps:** bump react-tooltip from 5.28.1 to 5.29.0 in /booking-ui ([#955](https://github.com/PandinoCloudCrew/seatsurfing/issues/955)) ([4aba141](https://github.com/PandinoCloudCrew/seatsurfing/commit/4aba14196c0eaf11bf906f3626ca3d1c071c007a))
* **deps:** bump react-tooltip from 5.29.0 to 5.29.1 in /booking-ui ([#971](https://github.com/PandinoCloudCrew/seatsurfing/issues/971)) ([4bcfe5c](https://github.com/PandinoCloudCrew/seatsurfing/commit/4bcfe5c3001301d6813439a22089df31534926fc))
* **deps:** bump server dependencies ([#1093](https://github.com/PandinoCloudCrew/seatsurfing/issues/1093)) ([fdfe497](https://github.com/PandinoCloudCrew/seatsurfing/commit/fdfe4973d8d70f7e71e50607d4e93d4060536486))
* **deps:** bump typescript from 5.7.3 to 5.8.2 in /commons/ts ([#626](https://github.com/PandinoCloudCrew/seatsurfing/issues/626)) ([cfbcbc0](https://github.com/PandinoCloudCrew/seatsurfing/commit/cfbcbc01d7803b8d3d4789b150dd2266d70c1593))
* **deps:** bump typescript from 5.8.2 to 5.8.3 in /commons/ts ([#765](https://github.com/PandinoCloudCrew/seatsurfing/issues/765)) ([c822e2c](https://github.com/PandinoCloudCrew/seatsurfing/commit/c822e2cd04046b96eb87731f3669727ba22da1ea))
* **deps:** bump typescript from 5.8.3 to 5.9.2 in /commons/ts ([#1141](https://github.com/PandinoCloudCrew/seatsurfing/issues/1141)) ([97cfb8d](https://github.com/PandinoCloudCrew/seatsurfing/commit/97cfb8d1d69ddba9146674a847e0bb05e45fc94f))
* **deps:** update server dependencies ([#868](https://github.com/PandinoCloudCrew/seatsurfing/issues/868)) ([a21f6f1](https://github.com/PandinoCloudCrew/seatsurfing/commit/a21f6f1e95beb5a8ea5c4e7405ea23034b6d33be))
* **deps:** upgrade server dependencies ([#1072](https://github.com/PandinoCloudCrew/seatsurfing/issues/1072)) ([d02ec29](https://github.com/PandinoCloudCrew/seatsurfing/commit/d02ec29a503f1710d871d30e3f76f2270a5eebb5))
* disable "allow any user" checkbox if no auth provider exists ([#1091](https://github.com/PandinoCloudCrew/seatsurfing/issues/1091)) ([77cd89d](https://github.com/PandinoCloudCrew/seatsurfing/commit/77cd89d48a893295b538eabd56ba4ab6217ae975))
* display version on preferences page in Admin UI ([#726](https://github.com/PandinoCloudCrew/seatsurfing/issues/726)) ([df48d44](https://github.com/PandinoCloudCrew/seatsurfing/commit/df48d445b31086f9592f851290f785757ff1f6e2))
* domain handling ([#646](https://github.com/PandinoCloudCrew/seatsurfing/issues/646)) ([d744fe2](https://github.com/PandinoCloudCrew/seatsurfing/commit/d744fe251885eec23b42ff893e7758d976afbd9c))
* duplicate keys on analytics page ([#586](https://github.com/PandinoCloudCrew/seatsurfing/issues/586)) ([fc05165](https://github.com/PandinoCloudCrew/seatsurfing/commit/fc051651e497ada90a40a044c22483e84438ef9e))
* encapsulate in-memory cache ([#995](https://github.com/PandinoCloudCrew/seatsurfing/issues/995)) ([4c657f9](https://github.com/PandinoCloudCrew/seatsurfing/commit/4c657f9cb6a1220761e09e7cf327b9cb3a79d732))
* enforce minimum length for group name ([#865](https://github.com/PandinoCloudCrew/seatsurfing/issues/865)) ([4b6d8ad](https://github.com/PandinoCloudCrew/seatsurfing/commit/4b6d8ad9b5448a5dfcd29553a8dace7f45c4c4e0))
* ensure space position is int instead of float ([#1113](https://github.com/PandinoCloudCrew/seatsurfing/issues/1113)) ([3ec437c](https://github.com/PandinoCloudCrew/seatsurfing/commit/3ec437c0c78c3f9781768c9a7ad1f43987aa8b52))
* ensure that a recurring booking includes start date's weekday (frontend) ([#1018](https://github.com/PandinoCloudCrew/seatsurfing/issues/1018)) ([a6be286](https://github.com/PandinoCloudCrew/seatsurfing/commit/a6be2868e6c1444840baef56e9cd010c74e7bf21))
* error "dial tcp &lt;IP&gt;:443: connect: connection refused" when connected via HTTP ([#741](https://github.com/PandinoCloudCrew/seatsurfing/issues/741)) ([f1da980](https://github.com/PandinoCloudCrew/seatsurfing/commit/f1da9809ddd259dc51e8f8cbe8dbebc86474c768))
* frame-src ([#664](https://github.com/PandinoCloudCrew/seatsurfing/issues/664)) ([f5d2ac3](https://github.com/PandinoCloudCrew/seatsurfing/commit/f5d2ac3fb62f97146a1834668796878dbf682542))
* frontend plugin support ([#598](https://github.com/PandinoCloudCrew/seatsurfing/issues/598)) ([80fc5c3](https://github.com/PandinoCloudCrew/seatsurfing/commit/80fc5c344f06c04c97e153eee50437af00ede5f6))
* handle text overflow in list view ([#980](https://github.com/PandinoCloudCrew/seatsurfing/issues/980)) ([7b883b7](https://github.com/PandinoCloudCrew/seatsurfing/commit/7b883b7f0cc49e10ea48b5a613b5b2afbdc8b7ba))
* hide "cancel upcoming bookings" checkbox if not my booking ([#1038](https://github.com/PandinoCloudCrew/seatsurfing/issues/1038)) ([2dfb5d8](https://github.com/PandinoCloudCrew/seatsurfing/commit/2dfb5d8e1cb136bb1f08de539f28fb194360370a))
* highlight items in Admin UI Sidebar ([#1086](https://github.com/PandinoCloudCrew/seatsurfing/issues/1086)) ([03fb359](https://github.com/PandinoCloudCrew/seatsurfing/commit/03fb3590597d0ea3fc0febdf754115f0c448afaa))
* improve ACS error handling ([#673](https://github.com/PandinoCloudCrew/seatsurfing/issues/673)) ([7de5e54](https://github.com/PandinoCloudCrew/seatsurfing/commit/7de5e540bbf3d1926ec2d7cb7a73d3af5e9a2829))
* improve adding and checking custom domains ([#777](https://github.com/PandinoCloudCrew/seatsurfing/issues/777)) ([9cacc6c](https://github.com/PandinoCloudCrew/seatsurfing/commit/9cacc6c14cd569da86bb5deadbb27bccd8578027))
* improve auth/verify handling (accept user id directly) ([#873](https://github.com/PandinoCloudCrew/seatsurfing/issues/873)) ([877d481](https://github.com/PandinoCloudCrew/seatsurfing/commit/877d4819f7ed9c82d384b9ce3c335a303c9609b0))
* improve cloud upgrade hints ([#1090](https://github.com/PandinoCloudCrew/seatsurfing/issues/1090)) ([60bb808](https://github.com/PandinoCloudCrew/seatsurfing/commit/60bb8086a78ef4ac8fc58087434cb4d954a1116d))
* improve compatibility with Postgres &lt; v16 ([#679](https://github.com/PandinoCloudCrew/seatsurfing/issues/679)) ([65a3186](https://github.com/PandinoCloudCrew/seatsurfing/commit/65a3186035346d5cf9ae8ab562442329769bebbe))
* improve GetAllDaysPassedSinceSignup function ([#1187](https://github.com/PandinoCloudCrew/seatsurfing/issues/1187)) ([98ed8d1](https://github.com/PandinoCloudCrew/seatsurfing/commit/98ed8d16bcbcbe6da6565ace41cb47d9ef08419d))
* improve html email formatting ([#827](https://github.com/PandinoCloudCrew/seatsurfing/issues/827)) ([07d3322](https://github.com/PandinoCloudCrew/seatsurfing/commit/07d332225d567435fa279ab72849fd8154c922d4))
* improve iframe height handling ([#585](https://github.com/PandinoCloudCrew/seatsurfing/issues/585)) ([8ee0141](https://github.com/PandinoCloudCrew/seatsurfing/commit/8ee01417a819ab1ef292d12840fea01cb3ba7a94))
* improve legacy login ([#657](https://github.com/PandinoCloudCrew/seatsurfing/issues/657)) ([a52ad78](https://github.com/PandinoCloudCrew/seatsurfing/commit/a52ad789653af853b1e0791d1f0f5270f34eb395))
* improve plugin display in Admin UI ([#778](https://github.com/PandinoCloudCrew/seatsurfing/issues/778)) ([3c34a23](https://github.com/PandinoCloudCrew/seatsurfing/commit/3c34a2374367433ac4e0d8c723879d8d547857b6))
* improve primary domain setting ([#659](https://github.com/PandinoCloudCrew/seatsurfing/issues/659)) ([97797ad](https://github.com/PandinoCloudCrew/seatsurfing/commit/97797adf100d17681b7419123e3dcd0a0405a9dd))
* improve resilience when saving locations/spaces ([#1177](https://github.com/PandinoCloudCrew/seatsurfing/issues/1177)) ([0f31067](https://github.com/PandinoCloudCrew/seatsurfing/commit/0f31067d1a8ffc53a4d56fdaf4041cb4ca9a2175))
* improved playwright test resilience ([#1025](https://github.com/PandinoCloudCrew/seatsurfing/issues/1025)) ([913a913](https://github.com/PandinoCloudCrew/seatsurfing/commit/913a913fd6a2c34f647ae96d5cbe7adf20927722))
* improved resilience and logging for auth providers ([#871](https://github.com/PandinoCloudCrew/seatsurfing/issues/871)) ([b1ab0a4](https://github.com/PandinoCloudCrew/seatsurfing/commit/b1ab0a40de72bf4ac71c0ceccaa5febd97109192))
* incorrect access token expiry ([#1176](https://github.com/PandinoCloudCrew/seatsurfing/issues/1176)) ([3f0007e](https://github.com/PandinoCloudCrew/seatsurfing/commit/3f0007ea7404559f12d113ab55e5497fcdccc893))
* incorrect html escapes ([#1009](https://github.com/PandinoCloudCrew/seatsurfing/issues/1009)) ([62e9fff](https://github.com/PandinoCloudCrew/seatsurfing/commit/62e9fff805c981dac64f3d33f1b9965574222851))
* incorrect i18n redirects in admin and booking ui ([#900](https://github.com/PandinoCloudCrew/seatsurfing/issues/900)) ([2d096f6](https://github.com/PandinoCloudCrew/seatsurfing/commit/2d096f68f845059c563db7ba11a7997f724a8d37))
* incorrect IdP URL ([#1000](https://github.com/PandinoCloudCrew/seatsurfing/issues/1000)) ([469d5d7](https://github.com/PandinoCloudCrew/seatsurfing/commit/469d5d7249c3361519d9b90911b4fdae624e571c))
* incorrect links in mail templates ([d86897f](https://github.com/PandinoCloudCrew/seatsurfing/commit/d86897f1b153deca621c038ccd96f2f54d8b421a))
* incorrect links in mail templates ([#1004](https://github.com/PandinoCloudCrew/seatsurfing/issues/1004)) ([6310001](https://github.com/PandinoCloudCrew/seatsurfing/commit/6310001715cb316502965400a9b0cd771eb44517))
* incorrect timezone when querying availability without params ([#943](https://github.com/PandinoCloudCrew/seatsurfing/issues/943)) ([29d446d](https://github.com/PandinoCloudCrew/seatsurfing/commit/29d446d107a8b22171f4c5a4d31292800a1e2cbe))
* **lang:** add Polish translations ([#1194](https://github.com/PandinoCloudCrew/seatsurfing/issues/1194)) ([6fbbae6](https://github.com/PandinoCloudCrew/seatsurfing/commit/6fbbae615eafd64211a5a284b35fe6f9bd95fb65))
* list user bookings according to location's timezone ([#619](https://github.com/PandinoCloudCrew/seatsurfing/issues/619)) ([76196b2](https://github.com/PandinoCloudCrew/seatsurfing/commit/76196b29e045d891c1d1162f8010ddefaf3af51d))
* login via confluence app ([#1005](https://github.com/PandinoCloudCrew/seatsurfing/issues/1005)) ([435d4c7](https://github.com/PandinoCloudCrew/seatsurfing/commit/435d4c7939dd9839f3fb3a9689c786410d9cd7fb))
* make i18n redirect more resilient ([#898](https://github.com/PandinoCloudCrew/seatsurfing/issues/898)) ([06f9163](https://github.com/PandinoCloudCrew/seatsurfing/commit/06f916390d100cf3e110f8d59294e33b34ec44cb))
* make language changes persistent ([#735](https://github.com/PandinoCloudCrew/seatsurfing/issues/735)) ([f33355d](https://github.com/PandinoCloudCrew/seatsurfing/commit/f33355d39a5b5d0ad4e77e4dbbae2286ac6af718))
* make sure random code generator always returns a 6 digit code ([#1145](https://github.com/PandinoCloudCrew/seatsurfing/issues/1145)) ([794a913](https://github.com/PandinoCloudCrew/seatsurfing/commit/794a913e246c0b9d1f7314d94bd4b7434aea7b0e))
* max booking duration not respected in daily basis booking mode ([#705](https://github.com/PandinoCloudCrew/seatsurfing/issues/705)) ([8db649e](https://github.com/PandinoCloudCrew/seatsurfing/commit/8db649e855cfdd1a12ea250092c2c894e2c37cd2))
* move admin setting "allowAnyUser" to auth provider section and add tooltip ([#949](https://github.com/PandinoCloudCrew/seatsurfing/issues/949)) ([27090fb](https://github.com/PandinoCloudCrew/seatsurfing/commit/27090fb3c34d702d403c0ab550a42eaec44b6575))
* multi-day bookings can fail ([#723](https://github.com/PandinoCloudCrew/seatsurfing/issues/723)) ([88eff18](https://github.com/PandinoCloudCrew/seatsurfing/commit/88eff18fa5f655eff4286f09e29b379d13ec2f24))
* nginx reverse proxy improvements ([#951](https://github.com/PandinoCloudCrew/seatsurfing/issues/951)) ([831a3bf](https://github.com/PandinoCloudCrew/seatsurfing/commit/831a3bf552db044610f009e9ad3759d73469a201))
* omit location in space response ([#698](https://github.com/PandinoCloudCrew/seatsurfing/issues/698)) ([a343a62](https://github.com/PandinoCloudCrew/seatsurfing/commit/a343a6268041051f245ba5a7f27f4c72af917e1f))
* omit markup when creating recurring bookings ([#990](https://github.com/PandinoCloudCrew/seatsurfing/issues/990)) ([70f7397](https://github.com/PandinoCloudCrew/seatsurfing/commit/70f7397ad7cb9268c0e03a8987c169f0911860b4))
* optimize language handling in Admin and Booking UI ([#714](https://github.com/PandinoCloudCrew/seatsurfing/issues/714)) ([37e64d4](https://github.com/PandinoCloudCrew/seatsurfing/commit/37e64d461811dd8fd3c368a66efd21752846a523))
* perform database schema updates more resilient ([#676](https://github.com/PandinoCloudCrew/seatsurfing/issues/676)) ([c066560](https://github.com/PandinoCloudCrew/seatsurfing/commit/c066560b97a09158e3533b95b52858f2109c1d19))
* prevent clipping of search widget (Booking UI) ([#768](https://github.com/PandinoCloudCrew/seatsurfing/issues/768)) ([b30ce06](https://github.com/PandinoCloudCrew/seatsurfing/commit/b30ce06bc73775703b1ceb6f81c567f3bf38043d))
* prevent crash when a weekly recurring booking does not include start date's weekday (backend) ([#1013](https://github.com/PandinoCloudCrew/seatsurfing/issues/1013)) ([ba8ade4](https://github.com/PandinoCloudCrew/seatsurfing/commit/ba8ade4b4fcf148a4c55bd2e39df64ac186903b6))
* prevent crash when reading email address from auth provider response fails ([#688](https://github.com/PandinoCloudCrew/seatsurfing/issues/688)) ([d452961](https://github.com/PandinoCloudCrew/seatsurfing/commit/d4529618a2457712d978afbd29473fcfb3855072))
* prevent placing a recurring booking with zero actual bookings ([#1010](https://github.com/PandinoCloudCrew/seatsurfing/issues/1010)) ([4971c4f](https://github.com/PandinoCloudCrew/seatsurfing/commit/4971c4f23439bd8d399ec99c05dd999b2a2e719d))
* redirect to actual domain ([#662](https://github.com/PandinoCloudCrew/seatsurfing/issues/662)) ([7e5059e](https://github.com/PandinoCloudCrew/seatsurfing/commit/7e5059e5c53beb1f8607890ce65914c4d3c42866))
* remove backplane ([#594](https://github.com/PandinoCloudCrew/seatsurfing/issues/594)) ([77703da](https://github.com/PandinoCloudCrew/seatsurfing/commit/77703da5e13c1cfa01b477ee1432c28af76e8d98))
* remove domain accessibility validation excludes ([#762](https://github.com/PandinoCloudCrew/seatsurfing/issues/762)) ([2398814](https://github.com/PandinoCloudCrew/seatsurfing/commit/2398814dfe4a6f89c84b9d2bf9dd02a4eb234d82))
* remove FRONTEND_URL and PUBLIC_URL ([#733](https://github.com/PandinoCloudCrew/seatsurfing/issues/733)) ([108d555](https://github.com/PandinoCloudCrew/seatsurfing/commit/108d555aab290e19306b37c54973167b43b467db))
* remove i18next dependency ([#1046](https://github.com/PandinoCloudCrew/seatsurfing/issues/1046)) ([ad1e3af](https://github.com/PandinoCloudCrew/seatsurfing/commit/ad1e3afa5cc1a006f6da5642159ae6a599496e8b))
* remove obsolete dev mode ajax prefixes ([#895](https://github.com/PandinoCloudCrew/seatsurfing/issues/895)) ([4944194](https://github.com/PandinoCloudCrew/seatsurfing/commit/49441944b3c05bb46f472cc7ff819b0afc32b925))
* remove obsolete files ([#655](https://github.com/PandinoCloudCrew/seatsurfing/issues/655)) ([bb0a8b0](https://github.com/PandinoCloudCrew/seatsurfing/commit/bb0a8b04f616db1942eaec28ed94a4c1197506df))
* remove obsolete params from development run script ([#742](https://github.com/PandinoCloudCrew/seatsurfing/issues/742)) ([1c8a9f0](https://github.com/PandinoCloudCrew/seatsurfing/commit/1c8a9f092a7d20ee68d81a4aaedb8d3bca1a04d7))
* remove obsolete route ([#893](https://github.com/PandinoCloudCrew/seatsurfing/issues/893)) ([78f4d00](https://github.com/PandinoCloudCrew/seatsurfing/commit/78f4d00a169875e0dca4965ba041aa23e48c9dd1))
* remove unused spaces from MiniMap component to fix tests and improve performance ([#887](https://github.com/PandinoCloudCrew/seatsurfing/issues/887)) ([5571624](https://github.com/PandinoCloudCrew/seatsurfing/commit/5571624a58e24754f92b5a2a4221c0820bdb6a31))
* replace "organisation" by "organization" in English translation ([#960](https://github.com/PandinoCloudCrew/seatsurfing/issues/960)) ([137bb40](https://github.com/PandinoCloudCrew/seatsurfing/commit/137bb401f8027d5453f1576f224adfc559be0f4e))
* script for adding missing translations ([#1027](https://github.com/PandinoCloudCrew/seatsurfing/issues/1027)) ([e32da8d](https://github.com/PandinoCloudCrew/seatsurfing/commit/e32da8d94a639d9a4d7a1a80615a3690239fa19f))
* send booking mail notification on update ([#826](https://github.com/PandinoCloudCrew/seatsurfing/issues/826)) ([83ba352](https://github.com/PandinoCloudCrew/seatsurfing/commit/83ba352d3eada216ffb014e64764838c46153562))
* server docker build ([#589](https://github.com/PandinoCloudCrew/seatsurfing/issues/589)) ([e86d3ea](https://github.com/PandinoCloudCrew/seatsurfing/commit/e86d3ea55182ba963cec134f703ef4ddf19fb514))
* show "no filters available info" in filter dialog ([#1037](https://github.com/PandinoCloudCrew/seatsurfing/issues/1037)) ([e52bfae](https://github.com/PandinoCloudCrew/seatsurfing/commit/e52bfae376000d3f5797d9224815dc2e2cc0d526))
* show 404 if org not found ([#666](https://github.com/PandinoCloudCrew/seatsurfing/issues/666)) ([3fa34a4](https://github.com/PandinoCloudCrew/seatsurfing/commit/3fa34a41e1b1ea65430b4ef7d79c6123187394aa))
* show absolute URL for auth provider's callback URL ([#950](https://github.com/PandinoCloudCrew/seatsurfing/issues/950)) ([b5fdb5d](https://github.com/PandinoCloudCrew/seatsurfing/commit/b5fdb5d20d149e346dcf09d592c40473f0ce274f))
* show number of bookings to be confirmed ([#992](https://github.com/PandinoCloudCrew/seatsurfing/issues/992)) ([9638eab](https://github.com/PandinoCloudCrew/seatsurfing/commit/9638eab6b79ae922e9866a694fbd19df510b13ea))
* stop polling pending approvals after logout ([#1167](https://github.com/PandinoCloudCrew/seatsurfing/issues/1167)) ([e8eb864](https://github.com/PandinoCloudCrew/seatsurfing/commit/e8eb86423d0471c29a167f731c59dd52ce68b603))
* support attachments when sending mails via ACS ([#825](https://github.com/PandinoCloudCrew/seatsurfing/issues/825)) ([cd3b954](https://github.com/PandinoCloudCrew/seatsurfing/commit/cd3b9544a68f66a6c13b105b9482093db7644be1))
* support conditions in email templates ([#1147](https://github.com/PandinoCloudCrew/seatsurfing/issues/1147)) ([3b550a3](https://github.com/PandinoCloudCrew/seatsurfing/commit/3b550a3dc77b270374c19c57ea2c0e263063e494))
* test case for password reset ([#1007](https://github.com/PandinoCloudCrew/seatsurfing/issues/1007)) ([0817e51](https://github.com/PandinoCloudCrew/seatsurfing/commit/0817e5167b354749f18103e9e314dc3601434725))
* too much logging in domain accessibility verification ([#783](https://github.com/PandinoCloudCrew/seatsurfing/issues/783)) ([19d551d](https://github.com/PandinoCloudCrew/seatsurfing/commit/19d551d8f3bd4419ebb143927213133143ccf5f0))
* translation differences between Admin and Booking UI ([#721](https://github.com/PandinoCloudCrew/seatsurfing/issues/721)) ([51a689d](https://github.com/PandinoCloudCrew/seatsurfing/commit/51a689d444be530b80e3b36c3fac6948954269ab))
* typo ([#665](https://github.com/PandinoCloudCrew/seatsurfing/issues/665)) ([bc4f8ad](https://github.com/PandinoCloudCrew/seatsurfing/commit/bc4f8ad102d16ab86d11ad759e86c6705c06939b))
* update fallback login link in admin login form ([#1053](https://github.com/PandinoCloudCrew/seatsurfing/issues/1053)) ([8dd59b5](https://github.com/PandinoCloudCrew/seatsurfing/commit/8dd59b5c407f8e6c92c51860e964bfaf9f3f9b9f))
* update French translation in booking UI ([#1014](https://github.com/PandinoCloudCrew/seatsurfing/issues/1014)) ([ff1b96f](https://github.com/PandinoCloudCrew/seatsurfing/commit/ff1b96f5d6cbd73e4f605153db18db41ae9f8066))
* update german translation for "add" ([#1181](https://github.com/PandinoCloudCrew/seatsurfing/issues/1181)) ([a57e282](https://github.com/PandinoCloudCrew/seatsurfing/commit/a57e282b69877cfaa894b8c06226ad96926998d5))
* update link text to fallback login form ([#1052](https://github.com/PandinoCloudCrew/seatsurfing/issues/1052)) ([6cc0732](https://github.com/PandinoCloudCrew/seatsurfing/commit/6cc073234e1fa291d788b3020cbf1a3b55a17766))
* use correct timezone in availability endpoint ([#942](https://github.com/PandinoCloudCrew/seatsurfing/issues/942)) ([274c8aa](https://github.com/PandinoCloudCrew/seatsurfing/commit/274c8aa08f2b3290f2c322ebf5134015faf583e0))
* use organization primary domain instead of global frontend url ([#661](https://github.com/PandinoCloudCrew/seatsurfing/issues/661)) ([7ae59b5](https://github.com/PandinoCloudCrew/seatsurfing/commit/7ae59b57771c8722b2f4749eb1d38c85eeb001f7))
* use path instead of full uri in whitelist check ([#761](https://github.com/PandinoCloudCrew/seatsurfing/issues/761)) ([adb7ca9](https://github.com/PandinoCloudCrew/seatsurfing/commit/adb7ca92890430a9d5e246b6282bf4012c468b34))
* warnings for deprecated env vars ([#989](https://github.com/PandinoCloudCrew/seatsurfing/issues/989)) ([ffcbcb1](https://github.com/PandinoCloudCrew/seatsurfing/commit/ffcbcb1539595ccbc1a1176e0e5302f0dffa749f))
